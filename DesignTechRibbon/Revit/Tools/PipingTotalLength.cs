...
namespace TotalLength
{
    ...
    public class PipingTotalLength : IExternalCommand
    {
        public class PipingFilter : ISelectionFilter
        {
            ...
            ElementSet elements)
        {
            ...
            try
            {
                ...
                PipingFilter selFilter = new PipingFilter();
                pickedRef = sel.PickElementsByRectangle(selFilter, "Select pipes");
                ...
                TaskDialog.Show("Pipe Length", sb.ToString());
